...
red_3_path = '/content/drive/MyDrive/img/Red_M_2023_3.tif'
blue_3_path = '/content/drive/MyDrive/img/Blue_M_2023_3.tif'
swir_3_path = '/content/drive/MyDrive/img/Swir_M_2023_3.tif'
nir_3_path = '/content/drive/MyDrive/img/Nir_M_2023_3.tif'

red_4_path = '/content/drive/MyDrive/img/Red_M_2023_4.tif'
blue_4_path = '/content/drive/MyDrive/img/Blue_M_2023_4.tif'
swir_4_path = '/content/drive/MyDrive/img/Swir_M_2023_4.tif'
nir_4_path = '/content/drive/MyDrive/img/Nir_M_2023_4.tif'

red_5_path = '/content/drive/MyDrive/img/Red_M_2023_5.tif'
blue_5_path = '/content/drive/MyDrive/img/Blue_M_2023_5.tif'
swir_5_path = '/content/drive/MyDrive/img/Swir_M_2023_5.tif'
nir_5_path = '/content/drive/MyDrive/img/Nir_M_2023_5.tif'

red_6_path = '/content/drive/MyDrive/img/Red_M_2023_6.tif'
blue_6_path = '/content/drive/MyDrive/img/Blue_M_2023_6.tif'
swir_6_path = '/content/drive/MyDrive/img/Swir_M_2023_6.tif'
nir_6_path = '/content/drive/MyDrive/img/Nir_M_2023_6.tif'

red_7_path = '/content/drive/MyDrive/img/Red_M_2023_7.tif'
blue_7_path = '/content/drive/MyDrive/img/Blue_M_2023_7.tif'
swir_7_path = '/content/drive/MyDrive/img/Swir_M_2023_7.tif'
nir_7_path = '/content/drive/MyDrive/img/Nir_M_2023_7.tif'

red_8_path = '/content/drive/MyDrive/img/Red_M_2023_8.tif'
blue_8_path = '/content/drive/MyDrive/img/Blue_M_2023_8.tif'
swir_8_path = '/content/drive/MyDrive/img/Swir_M_2023_8.tif'
nir_8_path = '/content/drive/MyDrive/img/Nir_M_2023_8.tif'

red_9_path = '/content/drive/MyDrive/img/Red_M_2023_9.tif'
blue_9_path = '/content/drive/MyDrive/img/Blue_M_2023_9.tif'
swir_9_path = '/content/drive/MyDrive/img/Swir_M_2023_9.tif'
nir_9_path = '/content/drive/MyDrive/img/Nir_M_2023_9.tif'

red_10_path = '/content/drive/MyDrive/img/Red_M_2023_10.tif'
blue_10_path = '/content/drive/MyDrive/img/Blue_M_2023_10.tif'
swir_10_path = '/content/drive/MyDrive/img/Swir_M_2023_10.tif'
nir_10_path = '/content/drive/MyDrive/img/Nir_M_2023_10.tif'

red_11_path = '/content/drive/MyDrive/img/Red_M_2023_11.tif'
blue_11_path = '/content/drive/MyDrive/img/Blue_M_2023_11.tif'
swir_11_path = '/content/drive/MyDrive/img/Swir_M_2023_11.tif'
nir_11_path = '/content/drive/MyDrive/img/Nir_M_2023_11.tif'
...
# Din media mastilor binare adaptive scoatem pragul specific pentru a obține valoarea finală a pragului
threshold = m10 - avg
