...
red_paths = [
    '/content/drive/MyDrive/img/Red_M_2024_3.tif',
    '/content/drive/MyDrive/img/Red_M_2024_4.tif',
    '/content/drive/MyDrive/img/Red_M_2024_5.tif',
    '/content/drive/MyDrive/img/Red_M_2024_6.tif',
    '/content/drive/MyDrive/img/Red_M_2024_7.tif',
    '/content/drive/MyDrive/img/Red_M_2024_8.tif',
    '/content/drive/MyDrive/img/Red_M_2024_9.tif',
    '/content/drive/MyDrive/img/Red_M_2024_10.tif',
    '/content/drive/MyDrive/img/Red_M_2024_11.tif'
]

blue_paths = [
    '/content/drive/MyDrive/img/Blue_M_2024_3.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_4.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_5.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_6.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_7.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_8.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_9.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_10.tif',
    '/content/drive/MyDrive/img/Blue_M_2024_11.tif'
]

swir_paths = [
    '/content/drive/MyDrive/img/Swir_M_2024_3.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_4.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_5.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_6.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_7.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_8.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_9.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_10.tif',
    '/content/drive/MyDrive/img/Swir_M_2024_11.tif'
]

nir_paths = [
    '/content/drive/MyDrive/img/Nir_M_2024_3.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_4.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_5.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_6.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_7.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_8.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_9.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_10.tif',
    '/content/drive/MyDrive/img/Nir_M_2024_11.tif'
]
...
plt.title('Mean BSI 2024')
plt.axis('off')

plt.subplot(1, 2, 2)
plt.imshow(cropped_binary_mask_mean, cmap='gray')
plt.title('Masca binară decupată (nisip) 2024')
plt.axis('off')
